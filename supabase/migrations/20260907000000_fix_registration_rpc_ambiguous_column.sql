-- Qualify the event_id returned by the atomic single-event registration RPC.
-- RETURNS TABLE creates an output variable named event_id; leaving the
-- RETURNING column unqualified makes PostgreSQL raise 42702 at INSERT time.
